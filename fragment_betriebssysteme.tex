...
\begin{answer}
Hängt man einem Befehl ein \& an, so wird dieser als \crucial{Hintergrundprozess} gestartet. Dieser \crucial{kann} dann zwar auf \texttt{stdout} \crucial{schreiben}, wird aber sofort in den Zustand \crucial{suspended} versetzt , wenn er versucht von der Standardeingabe (\textit{stdin}) zu lesen.
\end{answer}
