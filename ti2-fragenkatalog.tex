...
\newcommand{\crucial}[1]{\hlc[cream]{\textbf{#1}}} % Optimized for online reading
...
\newenvironment {answer}
                {}
                {}
                %{\par  \begin{addmargin}[1.5em]{0em}} % before
                %{\end{addmargin} \noindent \ignorespacesafterend \\*} % after
                  
\subsectionfont{\normalsize \normalfont} % We change the sections to have a slightly smaller size
...
% Template for question and answer pairs
%\question{}
%\begin{answer}
%\end{answer}
