...
\question{Nenne einige absichtliche und unabsichtliche Angriffe auf Hardware, Software und/oder Daten.}
\begin{answer}
...
\question{Welche grundsätzlichen Sicherheitsziele kann man unterscheiden? Was ist eine Sicherheitspolitik?}
\begin{answer}
...
\question{Auf welche verschiedenen Arten kann sich ein Benutzer authentifizieren?}
\begin{answer}
Wissen: z.B. Passwort
...
\question{Charakterisiere symetrische und asymetrische Verschlüsselungsverfahren. Wie können sie zur Realiesierung einer Vertraulichkeit eingesetzt werden? Warum werden häufig Mischformen eingesetzt?}
\begin{answer}
